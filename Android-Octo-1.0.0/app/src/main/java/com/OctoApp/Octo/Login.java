...
public class Login extends AppCompatActivity {
    ...
    private void LoginButton() {
        Button LoginButton = findViewById(R.id.LoginLPage);
    ...
    /**
     * @param Context
     * @param Messages <p>Writes the StayLoggedIn variable to the Settings.json file. StayLoggedIn equals the state of the switch.</p>
     */
    ...
    /**
     * @param Context
     * @param Messages <p>Checks users inputed username based on the information in the database.</p>
     */
    ...
    /**
     * @param Context
     * @param Messages <p>Checks password against the users password hash</p>
     */
