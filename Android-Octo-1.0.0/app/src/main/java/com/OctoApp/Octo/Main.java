...
public class Main extends AppCompatActivity {
    ...
    private final HashMap<String, String> FriendsAndTokens = new HashMap<>();
    ...
    /**
     * @param MoodAndColor
     * @param UserDatabase <p>Sets the MoodAndColor Dictionary with the values in the database.</p>
     */
    ...
    /**
     * @param MoodAndColor
     * @param UserDatabase <p>Gets the current mood from the database and sets it with the SetCurrentMood method.</p>
     */
     ...
     * @param MoodAndColor
     * @param Mood
     * @param UserDatabase <p>Sets the current mood given to the method. Sets the value in the database and sets the image to the corresponding color.</p>
     */
    ...
    /**
     * @param MoodAndColor
     * @param UserDatabase <p>Sets the MoodSpinner. If an item is selected then the current mood is set to the selected item and the prompt is changed.</p>
     */
